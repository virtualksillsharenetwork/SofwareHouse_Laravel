...
<ul>
<li><a href="contact-1.html" class="sw-btn sw-orange-btn header-btn">Contact Now </a></li>
...
<h1 class="mb20 wow fadeInUp" data-wow-delay=".2s">Web & Graphic Designer</h1>
...
<h3 class="mb20 wow fadeInUp" data-wow-delay=".4s">Hi, I'm Mike Deo</h3>
<p class="wow fadeInUp" data-wow-delay=".6s">A full-service digital marketing firm that specialises in human-centered experiences. We bring companies and people together.</p>
<a href="#" class="sw-btn sw-blue-btn mt60 wow fadeInUp" data-wow-delay=".8s">Start Your Project</a>
</div>
<div class="porttraiimg">
<div class="portrait-img"><img src="images/hero/portrait-2.png" alt="img"></div>
...
<div class="row">
<div class="col-lg-6">
<h2 class="text-gradient-1 wow fadeIn" data-wow-delay=".2s">Latest Projects</h2>
...
<p class="wow fadeIn" data-wow-delay=".6s">Blueket overcomes challenges, achieves results, and adds value to our clients and partners. Take a look at some of our clients' success stories. Take a look at some of our clients' success stories.</p>
</div>
</div>
</div>
...
<section class="pricing-block section-space bkbg0">
<div class="container">
<div class="row justify-content-center">
<div class="col-lg-10 text-center">
<span class="scriptheading mb15">We Work For</span>
<h3>Take a Look at My Clients</h3>
</div>
</div>
<div class="row mt60">
<div class="col-lg-12">
...
<div class="brand-logo"><img src="images/clients/appstore.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay=".4s">
<div class="brand-logo"><img src="images/clients/aspire-soft-tech.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay=".7s">
<div class="brand-logo"><img src="images/clients/clutchreview.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1s">
<div class="brand-logo"><img src="images/clients/fino-finance.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.3s">
<div class="brand-logo"><img src="images/clients/indowind.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.6s">
<div class="brand-logo"><img src="images/clients/lyka-pub.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="1.9s">
<div class="brand-logo"><img src="images/clients/manu-sunrise.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="2.2s">
<div class="brand-logo"><img src="images/clients/nuvoco.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="2.5s">
<div class="brand-logo"><img src="images/clients/riko-sound.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="2.8s">
<div class="brand-logo"><img src="images/clients/Surya-Software.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="3.1s">
<div class="brand-logo"><img src="images/clients/torex-oftware.svg" alt="clients" class="img-fluid"></div>
</li>
<li class=" wow fadeIn" data-wow-delay="3.4s">
<div class="brand-logo"><img src="images/clients/trustplot.svg" alt="clients" class="img-fluid"></div>
</li>
</ul>
</div>
</div>
...
<section class="industry-work section-space bg-efffect-1 pb300">
<div class="container index-up">
<div class="row">
<div class="col-lg-10">
<span class="scriptheading dashbefore mb15">Working Domain</span>
<h2 class="text-gradient-1">My Industry Wise Solution</h2>
</div>
</div>
<div class="row justify-content-between">
<div class="col-lg-12">
...
<p>Blueket is a company that specialises in risk management and general safety. </p>
</div>
</div>
...
<p>If you think to have a better outcome with low cost then Blueket is the one.</p>
</div>
</div>
</div>
</div>
...
<div class="icondiv"><img src="images/icons/dribbble.svg" alt="icon"></div>
<div class="mediainfoblock">
<h5>Dribbble </h5>
<p>Follow Me</p>
</div>
</a>
<a class="mediablock wow fadeIn" data-wow-delay=".4s" href="#">
<div class="icondiv"><img src="images/icons/behance.svg" alt="icon"></div>
<div class="mediainfoblock">
<h5>Behance </h5>
<p>Follow Me</p>
</div>
</a>
<a class="mediablock wow fadeIn" data-wow-delay=".7s" href="#">
<div class="icondiv"><img src="images/icons/artstations.svg" alt="icon"></div>
<div class="mediainfoblock">
<h5>Art station </h5>
<p>See My Design</p>
</div>
...
<a class="mediablock wow fadeIn" data-wow-delay="1s" href="#">
<div class="icondiv"><img src="images/icons/deviantart.svg" alt="icon"></div>
<div class="mediainfoblock">
<h5>Deviantart </h5>
<p>See My Design</p>
</div>
</a>
<a class="mediablock wow fadeIn" data-wow-delay="1.3s" href="#">
<div class="icondiv"><img src="images/icons/instagram.svg" alt="icon"></div>
<div class="mediainfoblock">
<h5>Instagram </h5>
<p>Follow Me</p>
</div>
...
<!-- Mirrored from separateweb.com/blueket-TM/demo-freelancer.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 04:19:26 GMT -->
</html>
