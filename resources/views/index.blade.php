...
<div class="loaderlogo"><img src="images/technopert-nobg.png" alt="logo"></div>
    ...
    <div class="service-name">Desktop<br> Development </div>
    <div class="circleffect">
    <div class="animation">&nbsp;</div>
    </div>
    </a>
    ...
    <a href="/about-us" class="sw-btn sw-blue-btn mt30">Read More</a>
    </div>
    </div>
    ...
    <a href="/projects-all" class="inline-btn mt20 wow fadeInUp" data-wow-delay=".8s">View all Projects <i class="fa-solid fa-arrow-trend-up"></i></a>
    </div>
    ...
    <a href="/contact-us" class="sw-btn sw-blue-btn mt30 wow fadeInUp" data-wow-delay="1s">Get Started <i class="fa-solid fa-arrow-trend-up"></i></a>
